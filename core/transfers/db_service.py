    ...
    async def get_proyectos_by_area(
        ...
        query = """
            SELECT
                ...
                p.status_fase,
                p.area_actual,
                p.fecha_inicio_area AT TIME ZONE 'America/Mexico_City' AS fecha_inicio_area,
                p.created_at        AT TIME ZONE 'America/Mexico_City' AS created_at,
                p.consecutivo,
    ...
    async def get_proyectos_pendientes_recepcion(
        ...
        query = """
            SELECT
                ...
                tr.fecha_envio AT TIME ZONE 'America/Mexico_City' AS fecha_envio,
                tr.comentario_envio,
    ...
    async def get_historial_traspasos(
        ...
        rows = await conn.fetch("""
            SELECT
                ...
                tr.fecha_recepcion  AT TIME ZONE 'America/Mexico_City' AS fecha_recepcion,
                tr.rechazado_por_nombre,
                tr.fecha_rechazo    AT TIME ZONE 'America/Mexico_City' AS fecha_rechazo,
                tr.comentario_envio,
